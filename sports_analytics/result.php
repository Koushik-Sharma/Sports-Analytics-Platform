...
<?php
// Aggregate stats for all quizzes
$sql = "SELECT 
        ...
        FROM quiz_results";
$agg = $conn->query($sql)->fetch_assoc();

echo "<h3>Quiz Performance Summary</h3>";
echo "<p><strong>Total Users Attempted:</strong> " . $agg['total_users'] . "</p>";
echo "<p><strong>Total Attempts:</strong> " . $agg['total_attempts'] . "</p>";
echo "<p><strong>Average Score:</strong> " . round($agg['average_score'], 2) . "</p>";
